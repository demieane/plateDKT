...
% E=2e9;%0.03e9;%1.88e9;
% v=0.4;
% h=0.12*chord; %NACA0012 average thickness profile
%
...
if lll==3
    [Fx]=Nonunif(x,y,IEN,p,e,t, chord, span, debugOn, importFromFile, fluid_dens, U);
    if debugOn
        hold on;grid on;
...
ansys=[3.9173e-05;5.0783e-06;6.4828e-07];%shell 181
num_mesh1=[4.3572e-05;5.6132e-06;7.0166e-07];
num_mesh2=[4.1129e-05;5.2984e-06;6.6231e-07];

(num_mesh1-ansys)./ansys*100
(num_mesh2-ansys)./ansys*100
...
if lll==1 % concentrated load at the midddle of the rectangular plate
    ...
    wanal=4*P_load/(Dplate*a*b*pi^4)*summ;
    ...
    wanal=16*P_load/(Dplate*pi^6)*summ;
end
