...
[XX,lamM,flag]=eigs(Kglob,Mglob,6,'smallestabs',...
    'IsSymmetricDefinite',0, 'Tolerance',1^(-3),'MaxIterations',2);
cc=sort(diag(lamM),'ascend');
res_Freq=sqrt(cc)./(2*pi);% frequency :[1/sec]
...
fprintf(' -Rayleigh Parameter1: a = %5.5f  \n',a)
fprintf(' -Rayleigh Parameter2: b = %5.5f  \n\n',b)
